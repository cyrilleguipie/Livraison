...
public class LocationTrack extends Service implements LocationListener {
    ...
    public void onLocationChanged(Location location) {
        if(location != null){
            Log.e("TRACK", "new lat "+location.getLatitude()+" long "+location.getLongitude());
            MainApplication.getPrefs().putString(Constants.LATITUDE, String.valueOf(location.getLatitude()));
            MainApplication.getPrefs().putString(Constants.LONGITUDE, String.valueOf(location.getLongitude()));
    ...
    private void position(double lat, double lng) {

        Call<ResponseBody> result = RestClient.getRestService().position(MainApplication.getPrefs().getInt(Constants.USER_ID, 0),
            lat, lng);
